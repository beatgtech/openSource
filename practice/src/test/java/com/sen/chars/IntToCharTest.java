...
class IntToCharTest {
    ...
    void testStage2method() {
        Assert.assertEquals("att atu atv aut auu auv avt avu avv btt btu btv but buu buv bvt bvu bvv ctt ctu ctv cut cuu cuv cvt cvu cvv", IntToChar.stage1method(new int[]{2, 88}));
        Assert.assertNull(IntToChar.stage1method(new int[]{0, 1}));
        Assert.assertNull(IntToChar.stage1method(new int[]{8, 100}));
        Assert.assertNull(IntToChar.stage1method(new int[]{-1, 1}));
    }
//
//    @Test
